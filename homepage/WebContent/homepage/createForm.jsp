  ...
  <TABLE>
    <TR>
     ...
     <TR>
      ...
      <button type="button" onclick="emailCheck(document.frm.email.value)">Email중복 확인</button>
      </td>
      <td>이메일을 적어주세요(*필수)</td>
    </TR>
     ...
     <TR>
      ...
      <button type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">주소 검색</button>
      </td>
      <td>우편번호를 적어주세요(*필수)</td>
    </TR>
     ...
     <TR>
      ...
      <option value='A02' selected>건물주</option>
      <option value='A03'>조물주</option>
      <option value='A04'>학생</option>
      <option value='A05'>일반자영업</option>
      <option value='A06'>공무원</option>
      <option value='A07'>의료인</option>
      <option value='A08'>연예인</option>
      <option value='A09'>운동선수</option>
